...
void Scene::init(void){
    ...
    material["jade"] -> ambient = vec4(0.135f, 0.2225f, 0.1575f, 1.0f);
    material["jade"] -> diffuse = vec4(0.54f, 0.89f, 0.63f, 1.0f);
    material["jade"] -> specular = vec4(0.316228f, 0.316228f, 0.316228f, 1.0f);
    material["jade"] -> shininess = 150.0f;

    material["pearl"] = new Material;
    material["pearl"] -> ambient = vec4(0.25f, 0.20725f, 0.20725f, 0.922f);
    material["pearl"] -> diffuse = vec4(1.0f, 0.829f, 0.829f, 0.922f);
    material["pearl"] -> specular = vec4(0.296648f, 0.296648f, 0.296648f, 0.922f);
    material["pearl"] -> shininess = 11.264f;

    material["chrome"] = new Material;
    material["chrome"] -> ambient = vec4(0.25f, 0.25f, 0.25f, 1.0f);
    material["chrome"] -> diffuse = vec4(0.4f, 0.4f, 0.4f, 1.0f);
    material["chrome"] -> specular = vec4(0.774597f, 0.774597f, 0.774597f, 1.0f);
    material["chrome"] -> shininess = 76.8f;
    ...
    model["table piece"] -> material = material["chrome"];
    ...
    model["bunny1"] -> material = material["jade"];

    model["bunny2"] = new Model;
    model["bunny2"] -> geometry = geometry["bunny"];
    model["bunny2"] -> material = material["pearl"];

    model["sphere"] = new Model;
    model["sphere"] -> geometry = geometry["sphere"];
    model["sphere"] -> material = material["bulb"];
    ...
    node["clownBunny"] = new Node;
    node["clownBunny1"] = new Node;
    node["nose"] = new Node;
    node["bunny"] = new Node;
    ...
    node["clownBunny"] -> childnodes.push_back( node["bunny"]);
    node["clownBunny"] -> childtransforms.push_back(translate(vec3(0.0f,0.0f, 0.0f)) );
    node["clownBunny"] -> childnodes.push_back( node["nose"] );
    node["clownBunny"] -> childtransforms.push_back(translate(vec3(-0.65f, 0.95f, 0.59f)) );
    
    node["clownBunny1"] -> childnodes.push_back( node["bunny1"] );
    node["clownBunny1"] -> childtransforms.push_back(translate(vec3(0.0f, 0.0f, 0.0f)) );
    node["clownBunny1"] -> childnodes.push_back( node["nose"] );
    node["clownBunny1"] -> childtransforms.push_back( translate(vec3(-0.7f, 0.95f, 0.59f)) );
    ...
    node["nose"] -> models.push_back(model["sphere"]);
    node["nose"] -> modeltransforms.push_back( scale(vec3(0.1f)) * translate(vec3(0.0f, 0.0f, 0.0f)) );
    
    node["bunny2"] -> models.push_back( model["bunny2"] );
    node["bunny2"] -> modeltransforms.push_back( scale(vec3(0.4f)) * translate(vec3(0.0f, 1.0f, 0.0f)) );
    
    node["world"] -> childnodes.push_back( node["table"] );
    node["world"] -> childtransforms.push_back( mat4(1.0f) );
    node["world"] -> childnodes.push_back( node["clownBunny"] );
    node["world"] -> childtransforms.push_back( translate(vec3(-1.8f,0.0f,0.0f)) * rotate( 90.0f*float(M_PI)/180.0f, vec3(0.0f, 1.0f, 0.0f) ));
    node["world"] -> childnodes.push_back(node["clownBunny1"]);
    node["world"] -> childtransforms.push_back(translate(vec3(1.5f, 0.0f, 0.0f)) * rotate(90.0f * float(M_PI) / 180.0f, vec3(0.0f, 1.0f, 0.0f) ));
    node["world"] -> childnodes.push_back(node["bunny2"]);
    node["world"] -> childtransforms.push_back(translate(vec3(0, 0.0f, 0.0f))* rotate(90.0f * float(M_PI) / 180.0f, vec3(0.0f, 1.0f, 0.0f)));
